 ...
 *
 * Common utility functions for program utilities.
 * Functions defines a common framework used in all utilities.
 */
/*
 * TODO:
 * - framework integration with pgsql-fd plugin
 */
 ...
 */
/* 
 * curently it assigns argv[0] into program_name variable only,
 * future enchancements possible.
 */
 ...
 */
void abortprg ( progdata * pdata, int err, const char * msg ){
 ...
 *    < 0 - value not found
 */
int _get_walid_from_catalog ( progdata * pdata ){
 ...
 */
int _get_walstatus_from_catalog ( progdata * pdata ){
 ...
 *    < 0 - on error
 */
int _insert_status_in_catalog ( progdata * pdata, int status ){
 ...
 *    1 - on error
 */
int _update_status_in_catalog ( progdata * pdata, int pgid, int status ){
 ...
 *    1 - error
 */
int _copy_wal_file ( progdata * pdata, char * src, char * dst ){
 ...
 *    -1 - error
 */
int _check_postgres_is_running ( progdata * pdata, char * pgdataloc ){
 ...
 */
const char * find_pgctl ( progdata * pdata ){
 ...
 *    -1 - on error
 */
int pgsql_msg_init ( progdata * pdata, int prg ){
 ...
 *    -1 - on error
 */
int pgsql_msg_send ( progdata * pdata, int msqid, uint type, const char * message ){
 ...
 *    number of received 
 */
int pgsql_msg_recv ( progdata * pdata, int msqid, int type, char * message ){
 ...
 */
void pgsql_msg_shutdown ( progdata * pdata, int msqid ){
